...
for (var i=0;i<m.length;i++){
  ...
  mpx[2]=p[player.index-1].position.x
  //Outro jogador X
  ...
  mpx[1]=p[m[i].indexXY].position.x
  //O jogador atual Y
  ...
  mpy[2]=p[player.index-1].position.y
  //Outro jogador Y
  ...
  mpy[1]=p[m[i].indexXY].position.y
  //Velocidade
  ...
  var dd = dist(m[i].sprite.position.x, m[i].sprite.position.y, mpx[2], mpy[2]), DD = dist(m[i].sprite.position.x, m[i].sprite.position.y, mpx[1], mpy[1])
...
//Destruir balas
if(i<buls.length&&(buls[i][1][0].sprite.position.x>p[player.index-1].position.x+windowWidth/1.9 || buls[i][1][0].sprite.position.x<p[player.index-1].position.x-windowWidth/1.9 || buls[i][1][0].sprite.position.y>p[player.index-1].position.y+windowHeight/1.9 || buls[i][1][0].sprite.position.y<p[player.index-1].position.y-windowHeight/1.9)){
  buls[i][1][0].Destroy(buls[i][0][0],buls[i][0][1],i)}
  }
}
}
...
if(m.length==0&&keyCode==32&&gameState==1){game.update(0)}
else if(gameState==0&&keyCode==32){game.update(1)}
  if(gameState==1){
    console.log(gameState)
  //W:
if(keyCode===87&&X!=1){setTimeout(()=>{if(player.index!=null){var bul = new Bullet(p[player.index-1].position.x,p[player.index-1].position.y,0,-vdb,d,player.index,1);buls.push([[player.index-1,TPIB],[bul]]),TPIB+=1;}},500)}
  //S:
if(keyCode===83&&X!=1){setTimeout(()=>{if(player.index!=null){var bul = new Bullet(p[player.index-1].position.x,p[player.index-1].position.y,0,vdb,d,player.index,1);buls.push([[player.index-1,TPIB],[bul]]),TPIB+=1}},500)}
  //A:
if(keyCode===65&&X!=1){setTimeout(()=>{if(player.index!=null){var bul = new Bullet(p[player.index-1].position.x,p[player.index-1].position.y,-vdb,0,d,player.index,1);buls.push([[player.index-1,TPIB],[bul]]),TPIB+=1}},500)}
  //D:
if(keyCode===68&&X!=1){setTimeout(()=>{if(player.index!=null){var bul = new Bullet(p[player.index-1].position.x,p[player.index-1].position.y,vdb,0,d,player.index,1);buls.push([[player.index-1,TPIB],[bul]]),TPIB+=1}},500)}

//Contrario do Relogio
//W:
if(keyCode===87&&X==1){setTimeout(()=>{if(player.index!=null){var bul = new Bullet(p[player.index-1].position.x,p[player.index-1].position.y,-vdb,-vdb,d,player.index,1);buls.push([[player.index-1,TPIB],[bul]]),TPIB+=1}},500)}
  //S:
if(keyCode===83&&X==1){setTimeout(()=>{if(player.index!=null){var bul = new Bullet(p[player.index-1].position.x,p[player.index-1].position.y,vdb,vdb,d,player.index,1);buls.push([[player.index-1,TPIB],[bul]]),TPIB+=1}},500)}
  //A:
if(keyCode===65&&X==1){setTimeout(()=>{if(player.index!=null){var bul = new Bullet(p[player.index-1].position.x,p[player.index-1].position.y,-vdb,vdb,d,player.index,1);buls.push([[player.index-1,TPIB],[bul]]),TPIB+=1}},500)}
  //D:
if(keyCode===68&&X==1){setTimeout(()=>{if(player.index!=null){var bul = new Bullet(p[player.index-1].position.x,p[player.index-1].position.y,vdb,-vdb,d,player.index,1);buls.push([[player.index-1,TPIB],[bul]]),TPIB+=1}},500)}
}
...
function retirarJ(i){
  ...
  p[i].visible=false;p.splice(i,1);plca=Math.round(random(0,p.length-1))
