...
speed(px,py,i){
if(this.sprite.position.x>px){this.X=-1}else if(this.sprite.position.x<px){this.X=1}else{this.X=0}
if(this.sprite.position.y>py){this.Y=-1}else if(this.sprite.position.y<py){this.Y=1}else{this.Y=0}
